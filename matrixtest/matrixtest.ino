...
const uint32_t image_data[] PROGMEM = {
    0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 
    0x000000, 0xd50000, 0xd50000, 0x000000, 0x000000, 0xd50000, 0xd50000, 0x000000, 
...
void show() {
  ...
  for(uint16_t j=0; j < 3; j++) {
    ...
    for(uint16_t i=0; i < matrix.numPixels(); i++) {
      uint16_t idx = 3*i;
      matrix.setPixelColor(i, pgm_read_dword(&(image_data[i])));
    }
    matrix.show();
    delay(1000);
  }
